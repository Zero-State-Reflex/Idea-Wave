...
// Current mainstream topics — earth tone palette
export const TOPICS = [
  { text: 'Iran War', color: '#c4723a', lat: 32, lon: 53 },
  { text: 'Healthcare Crisis', color: '#8faa6e', lat: 39, lon: -98 },
  { text: 'Artificial Intelligence', color: '#b89f6a', lat: 37.8, lon: -122.4 },
  { text: 'Climate Change', color: '#6b8f5e', lat: 48.9, lon: 2.3 },
  { text: 'Cost of Living', color: '#c49a5c', lat: 51.5, lon: -0.1 },
  { text: 'Immigration', color: '#a67b5b', lat: 30, lon: -97 },
  { text: 'Cryptocurrency', color: '#d4a855', lat: 1.4, lon: 103.8 },
  { text: 'Mental Health', color: '#7a9e8e', lat: 43.7, lon: -79.4 },
  { text: 'Election Politics', color: '#b5704f', lat: 38.9, lon: -77.0 },
  { text: 'Space Exploration', color: '#8a8e7a', lat: 28.5, lon: -80.6 },
  { text: 'Misinformation', color: '#c98b5a', lat: 35.7, lon: 139.7 },
  { text: 'Renewable Energy', color: '#7aaa6b', lat: 55.7, lon: 12.6 },
  { text: 'Student Debt', color: '#b89870', lat: 42.4, lon: -71.1 },
  { text: 'Global Trade Wars', color: '#6e8a7a', lat: 31.2, lon: 121.5 },
  { text: 'Nuclear Threat', color: '#b06040', lat: 39.0, lon: 125.8 },
  { text: 'Water Crisis', color: '#5e8a8a', lat: 28.6, lon: 77.2 },
  { text: 'Housing Shortage', color: '#a08060', lat: -33.9, lon: 151.2 },
  { text: 'Pandemic Preparedness', color: '#6a9a72', lat: 39.9, lon: 116.4 },
];
