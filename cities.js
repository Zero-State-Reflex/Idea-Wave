...
// Current mainstream topics — pinned to origin locations on the globe
export const TOPICS = [
  { text: 'Iran War', color: '#ff4444', lat: 32, lon: 53 },
  { text: 'Healthcare Crisis', color: '#44ddff', lat: 39, lon: -98 },
  { text: 'Artificial Intelligence', color: '#aa66ff', lat: 37.8, lon: -122.4 },
  { text: 'Climate Change', color: '#44ff88', lat: 48.9, lon: 2.3 },
  { text: 'Cost of Living', color: '#ffaa33', lat: 51.5, lon: -0.1 },
  { text: 'Immigration', color: '#ff6699', lat: 30, lon: -97 },
  { text: 'Cryptocurrency', color: '#ffdd44', lat: 1.4, lon: 103.8 },
  { text: 'Mental Health', color: '#66bbff', lat: 43.7, lon: -79.4 },
  { text: 'Election Politics', color: '#ff5577', lat: 38.9, lon: -77.0 },
  { text: 'Space Exploration', color: '#8899ff', lat: 28.5, lon: -80.6 },
  { text: 'Misinformation', color: '#ff8844', lat: 35.7, lon: 139.7 },
  { text: 'Renewable Energy', color: '#33ff99', lat: 55.7, lon: 12.6 },
  { text: 'Student Debt', color: '#ddaa55', lat: 42.4, lon: -71.1 },
  { text: 'Global Trade Wars', color: '#55ccdd', lat: 31.2, lon: 121.5 },
  { text: 'Nuclear Threat', color: '#ff3333', lat: 39.0, lon: 125.8 },
  { text: 'Water Crisis', color: '#3399ff', lat: 28.6, lon: 77.2 },
  { text: 'Housing Shortage', color: '#ee8866', lat: -33.9, lon: 151.2 },
  { text: 'Pandemic Preparedness', color: '#77ddaa', lat: 39.9, lon: 116.4 },
];
